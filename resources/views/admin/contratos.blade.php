...
<head>
    ...
    <title>Contratos - InmoLegal</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="filters">
            <form method="GET" action="{{ route('admin.contratos') }}">
                ...
                <a href="{{ route('admin.contratos') }}" class="btn btn-secondary">Limpiar</a>
            </form>
        </div>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="{{ route('admin.ver-contrato', $contrato->token) }}" class="token-link">
                                {{ $contrato->token }}
                            </a>
                        </td>
